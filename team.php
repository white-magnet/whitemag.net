...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="http://data.whitemag.net/css/fancybox.css" media="screen, projection" />
    <script src="http://data.whitemag.net/js/jquery-fancybox.min.js" type="text/javascript"></script>
        ...
        <div class="section-mid">
          ...
          <div id="team-content">
            <div class="member first">
              <a class="profile-popup" href="#kulbir" title="Kulbir Saini"><img src="http://data.whitemag.net/images/team/kulbir.png" class="avatar" alt="" /></a>
            ...
            <div class="member">
              <a class="profile-popup" href="#sambhav" title="Sambhav Jain"><img src="http://data.whitemag.net/images/team/sambhav.png" class="avatar" alt="" /></a>
            ...
            <div class="member last">
              <a class="profile-popup" href="#mahaveer" title="Mahaveer Singh Deora"><img src="http://data.whitemag.net/images/team/mahaveer.png" class="avatar" alt="" /></a>
